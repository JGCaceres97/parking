...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-linear-to-br from-gray-200 via-gray-300 to-gray-400 text-gray-800 max-h-screen overflow-hidden">
                    ...
                    <div className="space-y-2 text-gray-700 text-sm">
                      <div className="flex items-center justify-between">
                        <span className="flex items-center gap-1 font-semibold">
                          <FaArrowCircleDown className="text-gray-500" />{" "}
                          Entrada:
                        </span>
